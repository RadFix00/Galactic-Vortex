...
<body>
    ...
    <section class="d-flex justify-content-center align-items-start vh-100">
        ...
        <div class="container">
            ...
            <div>
                 <form class="game-form" action="php/guardarjugador.php" method="POST">
                    <input 
                        class="shadow-lg my-1" 
                        type="text" 
                        name="nickname" 
                    ...
                    <button 
                        ...
                        class="game-button btn btn-lg btn-outline-light shadow-lg my-4" 
                        type="submit">
                        Jugar
                    </button>
                </form>
            ...
            <a 
                onmouseover="PlaySound('mySound')" 
                onmouseout="StopSound('mySound')" 
                href="html/terminoscondiciones.html" 
                class="terminos">
                ¿Como Jugar?
            </a>
        </div>
